...
ms.date: 02/19/2020
ms.author: lcozzens
ms.openlocfilehash: e69b8237f1be4d892c25fa748c0902e93bd0466d
ms.sourcegitcommit: f9a819b7429a2cca868eba0d9241d4e6b3cf905a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/26/2020
ms.locfileid: "88866722"
---
...
使用 [.NET Core 命令行接口 (CLI)](https://docs.microsoft.com/dotnet/core/tools/) 创建新的 ASP.NET Core MVC Web 应用项目。 
