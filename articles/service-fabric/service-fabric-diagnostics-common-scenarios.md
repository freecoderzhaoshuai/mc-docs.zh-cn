...
2. 单击左上角的“搜索”。 然后单击下一个面板上的筛选器。
    ...
    :::image type="content" source="media/service-fabric-diagnostics-common-scenarios/ai-search-filter.png" alt-text="AI 概述":::
...
<!--Not Available on ## How do I see container metrics?-->
<!--Not Available on [Container Monitoring solution](service-fabric-diagnostics-oms-containers.md)-->
...
<!-- Update_Description: new article about service fabric diagnostics common scenarios -->
<!--NEW.date: 09/14/2020-->