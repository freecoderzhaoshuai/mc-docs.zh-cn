...
1. 导航到`Advanced Settings`边栏选项卡
    ...
    :::image type="content" source="media/service-fabric-diagnostics-oms-syslog/workspace-settings.png" alt-text="工作区设置":::
...
<!-- Update_Description: new article about service fabric diagnostics oms syslog -->
<!--NEW.date: 09/14/2020-->