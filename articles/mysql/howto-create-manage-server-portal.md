...
ms.date: 01/13/2020
ms.openlocfilehash: 0e6799ab78477cb24f4829b79598dd13b88be000
ms.sourcegitcommit: 5116a603d3cac3cbc2e2370ff857f871f8f51a5f
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/08/2020
ms.locfileid: "89512883"
---
...
2. 选择“常规用途”或“内存优化”，具体取决于你要缩放到哪一层。  
   ...
   ![Azure 门户的屏幕截图，该门户用于在 Azure Database for MySQL 中选择“基本”、“常规用途”或“内存优化”层](./media/howto-create-manage-server-portal/change-pricing-tier.png)
...
2. 通过将滑块移动到所需的值来更改“vCore”  设置。
    ...
    ![Azure 门户的屏幕截图，该门户用于在 Azure Database for MySQL 中选择 vCore 选项](./media/howto-create-manage-server-portal/scaling-compute.png)
...
2. 通过将滑块向上移动到所需的值来更改“存储”  设置。
   ...
   ![Azure 门户的屏幕截图，该门户用于在 Azure Database for MySQL 中选择存储规模](./media/howto-create-manage-server-portal/scaling-storage.png)
...
1. 在 Azure 门户中选择服务器。 在“概览”窗口中，选择“重置密码”   。
   ...
   ![Azure 门户的屏幕截图，该门户用于在 Azure Database for MySQL 中重置密码](./media/howto-create-manage-server-portal/overview-reset-password.png)

2. 输入新密码并确认。 文本框会就密码复杂性要求提示你。

   ![Azure 门户的屏幕截图，该门户用于在 Azure Database for MySQL 中重置密码并进行保存](./media/howto-create-manage-server-portal/reset-password.png)
...
1. 在 Azure 门户中选择服务器。 在“概览”窗口中，选择“删除”。  
   ...
   ![Azure 门户的屏幕截图，该门户用于在 Azure Database for MySQL 中删除服务器](./media/howto-create-manage-server-portal/overview-delete.png)

2. 在输入框中键入服务器名称，确认这是要删除的服务器。

   ![Azure 门户的屏幕截图，该门户用于在 Azure Database for MySQL 中确认服务器删除操作](./media/howto-create-manage-server-portal/confirm-delete.png)
