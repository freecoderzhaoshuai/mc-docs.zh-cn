...
ms.author: v-junlch
ROBOTS: NOINDEX
ms.openlocfilehash: 084453655c197ef18a710f0efe3fb03dcc1442b4
ms.sourcegitcommit: b5ea35dcd86ff81a003ac9a7a2c6f373204d111d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/27/2020
ms.locfileid: "88946896"
---
...
| 缓存模拟器 |托管缓存提供本地缓存模拟器。 |用于 Redis 的 Azure 缓存没有模拟器，但可以通过[在本地运行 Redis](cache-development-faq.md#is-there-a-local-emulator-for-azure-cache-for-redis) 来提供模拟器体验。 |
...
迁移操作的第一步是选择与以前的托管缓存服务缓存大小匹配的大小，并根据应用程序的需求进行增减。 有关如何选择合适的 Azure Cache for Redis 产品/服务的详细信息，请参阅[选择合适的层](cache-overview.md#choosing-the-right-tier)。
