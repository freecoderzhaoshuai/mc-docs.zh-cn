...
ms.openlocfilehash: d0a91b0e2b75eea99f9a9ac7c5011688814d641b
ms.sourcegitcommit: 25d542cf9c8c7bee51ec75a25e5077e867a9eb8b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/09/2020
ms.locfileid: "89593727"
---
...
通常，如果用户已注册 MFA，请将其状态直接切换为“已强制执行”状态。 如果这样做了，则旧式身份验证应用将停止工作，因为用户尚未完成 Azure 多重身份验证注册并获得应用密码。 在某些情况下，此行为可能是理想的，但在用户完成注册前，这会影响用户的体验。
