---
title: HTTP 扩展数据协定 - Azure
description: 在本文中，你将学习如何使用 HTTP 协议在实时视频分析模块与 AI 或 CV 模块之间发送消息。
ms.topic: overview
origin.date: 09/14/2020
ms.date: 09/07/2020
ms.openlocfilehash: 66ca14fe4c6fafe6b6532a5935650f6e8c86f111
ms.sourcegitcommit: 2eb5a2f53b4b73b88877e962689a47d903482c18
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/03/2020
ms.locfileid: "89414104"
---
# <a name="http-extension-data-contract"></a>HTTP 扩展数据协定

在本文中，你将学习如何使用 HTTP 协议在实时视频分析模块与 AI 或 CV 模块之间发送消息。
...
如果模块返回的响应的内容类型是“application/json”，但 JSON 架构不遵循下面所述的推理元数据架构，则将通过管道转发消息负载，但互操作性会降低。
...
![类层次结构](./media/http-data-contract/class-hierarchy.png)
