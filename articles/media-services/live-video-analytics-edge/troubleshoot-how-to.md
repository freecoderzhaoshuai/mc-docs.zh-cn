...
ms.date: 09/07/2020
ms.openlocfilehash: 8cd5cb7d230a9948916ca4e59e8d99f526d0623e
ms.sourcegitcommit: 2eb5a2f53b4b73b88877e962689a47d903482c18
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/03/2020
ms.locfileid: "89413579"
---
...
1. 如果上述解决方案失败，请尝试以下操作：
    ...
    c. 如果所有方法均失败，请运行以下命令以获取一个压缩文件，其中包含所有[相关日志](../../iot-edge/troubleshoot.md#gather-debug-information-with-support-bundle-command)，并将其附加到[支持工单](https://ms.portal.azure.cn/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/newsupportrequest)。
