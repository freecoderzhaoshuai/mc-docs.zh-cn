...
ms.openlocfilehash: c993b6a764b9e022b29de10b4abd0c68ba42202f
ms.sourcegitcommit: bd6a558e3d81f01c14dc670bc1cf844c6fb5f6dc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2020
ms.locfileid: "89457412"
---
...
>[!NOTE]
>由于 Microsoft Operations Management Suite (OMS) 正在过渡到 Azure Monitor，因此术语即将发生变化。 本文将 OMS 网关称作 Azure Log Analytics 网关。 
>
...
1. 浏览服务列表，并选择“Log Analytics 工作区”。 
1. 选择工作区。
1. 在工作区边栏选项卡中，选择“概述”。 
1. 在“选择一个或多个数据源连接到工作区”下方，选择“Windows 和 Linux 代理管理” 。
1. 在边栏选项卡中，选择“下载 Log Analytics 网关”。
 
   ![下载 Log Analytics 网关的步骤屏幕截图](./media/gateway/download-gateway.png)

或 

1. 在工作区边栏选项卡中的“设置”下方，选择“代理管理” 。
1. 选择“下载 Log Analytics 网关”。
<!--Customized in MC-->
...
可以使用 Microsoft [Network Load Balancing (NLB)](https://docs.microsoft.com/windows-server/networking/technologies/network-load-balancing)、[Azure 负载均衡器](../../load-balancer/load-balancer-overview.md) 或基于硬件的负载均衡器来配置网关，使其具有高可用性。 负载均衡器通过在其节点之间重定向 Log Analytics 代理或 Operations Manager 管理服务器请求的连接来管理流量。 如果一台网关服务器出现故障，流量将重定向到其他节点。
