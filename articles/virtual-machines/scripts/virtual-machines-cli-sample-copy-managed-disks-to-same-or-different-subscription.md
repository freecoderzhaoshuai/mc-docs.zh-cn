...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 00e81364f62f126d64a077c244e686e6aeab62c3
ms.sourcegitcommit: e32bba428f5745beb5a23a6e99e5f1b36cfeb09e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/02/2020
ms.locfileid: "89310336"
---
<!--TITLE TO MEET SCORECARD-->
<!--Verified without the different subscription-->
<!--Verified successfully on Basic Scripts used-->
...
<!--CORRECT TO MEET SCORECARD ON to the same-->
...
<!-- Update_Description: new article about virtual machines cli sample copy managed disks to same or different subscription -->
<!--NEW.date: 09/07/2020-->