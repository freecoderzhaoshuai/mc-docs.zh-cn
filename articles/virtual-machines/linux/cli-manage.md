...
ms.openlocfilehash: 220f4d6bf1a2efe2cce8eee9823af89b9c8c91a8
ms.sourcegitcommit: f45809a2120ac7a77abe501221944c4482673287
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/13/2020
ms.locfileid: "90057637"
---
...
本文需要 Azure CLI 2.0.4 或更高版本。 运行 `az --version` 即可查找版本。 如果需要进行升级，请参阅[安装 Azure CLI](/cli/install-azure-cli)。
...
| 任务 | Azure CLI 命令 |
| --- | --- |
| 创建资源组 | `az group create --name myResourceGroup --location chinanorth` |
...
| 获取 VM 资源的使用情况 | `az vm list-usage --location chinanorth` |
| 获取所有可用 VM 大小 | `az vm list-sizes --location chinanorth` |
