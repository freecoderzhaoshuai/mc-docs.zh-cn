...
ms.author: v-yeche
ms.openlocfilehash: 097b0a4bfc74afcca366258a6dd10ba8048463f6
ms.sourcegitcommit: 42d0775781f419490ceadb9f00fb041987b6b16d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2020
ms.locfileid: "89456881"
---
...
:::image type="content" source="./media/detailed-troubleshoot-ssh-connection/ssh-tshoot1.png" alt-text="显示 SSH 服务组件的图表":::
...
:::image type="content" source="./media/detailed-troubleshoot-ssh-connection/ssh-tshoot2.png" alt-text="突出显示 SSH 客户端计算机组件的图表":::
...
:::image type="content" source="./media/detailed-troubleshoot-ssh-connection/ssh-tshoot3.png" alt-text="突出显示组织边缘设备的图表":::
...
:::image type="content" source="./media/detailed-troubleshoot-ssh-connection/ssh-tshoot4.png" alt-text="突出显示云服务终结点和 ACL 的图表":::
...
* **目标虚拟机上的 SSH 流量终结点的 ACL。** ACL 允许指定基于源 IP 地址允许或拒绝的从 Internet 传入的流量。 错误配置的 ACL 可能会阻止 SSH 流量传入终结点。 检查 ACL 以确保允许从代理服务器或其他边缘服务器的公共 IP 地址传入的流量。 有关详细信息，请参阅[关于网络访问控制列表 (ACL)](https://docs.microsoft.com/previous-versions/azure/virtual-network/virtual-networks-acl)。

若要将终结点从问题原因中排除，请删除当前终结点，创建另一个终结点，然后指定 SSH 名称（公共和专用端口号为 TCP 端口 22）。 有关详细信息，请参阅[在 Azure 中的虚拟机上设置终结点](https://docs.microsoft.com/previous-versions/azure/virtual-machines/windows/classic/setup-endpoints?toc=/virtual-machines/windows/classic/toc.json)。
...
:::image type="content" source="./media/detailed-troubleshoot-ssh-connection/ssh-tshoot5.png" alt-text="突出显示基于 Linux 的 Azure 虚拟机的图表":::
