...
ms.author: v-yeche
ms.openlocfilehash: 0ff678907e16cd10c0cb0ae7041f41dccc38ae4b
ms.sourcegitcommit: 42d0775781f419490ceadb9f00fb041987b6b16d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2020
ms.locfileid: "89456791"
---
...
<!--MOONCAKE: CUSTOMIZE ON REMOVE #format-and-mount-the-disk-->

大多数分发都提供 `fstab` nofail 或 nobootwait 参数   。 在启动时若无法装载磁盘，这些参数可使系统启动。 有关这些参数的详细信息，请查看分发文档。 有关在添加数据磁盘时如何将 Linux VM 配置为使用 UUID 的信息，请参阅[连接到 Linux VM 以装载新磁盘](../linux/add-disk.md)。
