...
ms.date: 09/16/2020
ms.author: v-tawe
ms.openlocfilehash: f16a62ed0029b108e5ad40f62c1b5fdd59ebe05c
ms.sourcegitcommit: 39410f3ed7bdeafa1099ba5e9ec314b4255766df
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/16/2020
ms.locfileid: "90678525"
---
...
- [Azure IoT 中心](https://azure.microsoft.com/services/iot-hub)和 [DPS](/iot-dps/) 将继续使用 Baltimore CyberTrust 根 CA，但其中间 CA 将会更改。 [单击此处了解详细信息](https://techcommunity.microsoft.com/t5/internet-of-things/azure-iot-tls-changes-are-coming-and-why-you-should-care/ba-p/1658456)。
...
- 软删除。 软删除功能增强了 Key Vault 和 Key Vault 对象的数据保护。 参阅概述主题[软删除概述](https://docs.azure.cn/key-vault/key-vault-ovw-soft-delete)，了解详细信息。
